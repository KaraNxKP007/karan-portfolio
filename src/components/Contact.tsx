  ...
  return (
    <section id="contact" style={{ backgroundColor: "#050816", padding: "80px 0" }}>
      <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "0 20px" }}>
        ...
        <div className="kp-contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", alignItems: "start" }}>

          {/* Form */}
          <div style={{ backgroundColor: "#100d25", border: "1px solid rgba(145,94,255,0.25)", borderRadius: "24px", padding: "32px" }}>
            ...
            <form ref={formRef} onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
              ...
              <button type="submit" disabled={status === "sending"} style={{
                background: "linear-gradient(135deg, #915EFF, #6d28d9)", color: "#ffffff",
                border: "none", borderRadius: "12px", padding: "13px 28px",
                fontSize: "15px", fontWeight: 700, cursor: status === "sending" ? "not-allowed" : "pointer",
                fontFamily: "Poppins, sans-serif", boxShadow: "0 0 24px rgba(145,94,255,0.3)",
                width: "fit-content", opacity: status === "sending" ? 0.7 : 1,
              }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <div style={{ backgroundColor: "#151030", border: "1px solid rgba(145,94,255,0.2)", borderRadius: "14px", padding: "16px 20px", position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "2px", background: "linear-gradient(90deg, #915EFF, #00cea8)" }} />
